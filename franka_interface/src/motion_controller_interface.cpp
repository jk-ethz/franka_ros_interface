...
void MotionControllerInterface::init(ros::NodeHandle& nh,
  ...
  if (!nh.getParam("/controllers_config/pose_controller", pose_controller_name_)) {
        pose_controller_name_ = "position_cartesian_pose_controller";
    }
  if (!nh.getParam("/controllers_config/default_controller", default_controller_name_)) {
        default_controller_name_ = "position_cartesian_pose_controller";
    }
  ...
  all_controllers_.push_back(pose_controller_name_);
  ...
  controller_name_to_mode_map_[pose_controller_name_] = -2;
  ...
  if(current_mode_ != control_mode)
  {
    switch (control_mode)
    {
      case franka_core_msgs::JointCommand::POSITION_MODE:
        ...
        stop_controllers.push_back(pose_controller_name_);
        break;
